                ...
                <div class="py-2 shadow card border-left-primary h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                <div class="mb-1 text-xs font-weight-bold text-primary text-uppercase"><a
                                        href="{{ route('pa.branch.index') }}">Branches</a></div>
            ...
            <div class="mb-4 col-xl-3 col-md-6">
                <div class="py-2 shadow card border-left-success h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                <div class="mb-1 text-xs font-weight-bold text-success text-uppercase"><a
                                        href="{{ route('product.index') }}">Products</a></div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="mb-0 mr-3 text-gray-800 h5 font-weight-bold">
                                            {{ $orders->where('order_status', 'Delivered')->count() }}</div>
                                    </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                ...
                                <div class="mb-0 text-gray-800 h5 font-weight-bold">
                                    {{ $orders->where('order_status', 'Pending')->count() }}</div>
                            </div>
                            <div class="col-auto">
